...
static const struct test_user_config_paths_ds
{
    ...
    { CONF_MAIN, MC_CONFIG_FILE },        { CONF_MAIN, MC_FHL_INI_FILE },
    { CONF_MAIN, MC_HOTLIST_FILE },       { CONF_MAIN, GLOBAL_KEYMAP_FILE },
    { CONF_MAIN, MC_USERMENU_FILE },      { CONF_DATA, EDIT_SYNTAX_FILE },
    { CONF_MAIN, EDIT_HOME_MENU },        { CONF_MAIN, MC_PANELS_FILE },
    { CONF_MAIN, MC_EXT_FILE },           { CONF_DATA, MC_SKINS_DIR },
    { CONF_DATA, VFS_SHELL_PREFIX },

    { CONF_DATA, MC_EXTFS_DIR },          { CONF_DATA, MC_HISTORY_FILE },
    { CONF_DATA, MC_FILEPOS_FILE },       { CONF_DATA, EDIT_HOME_CLIP_FILE },
    { CONF_DATA, MC_MACRO_FILE },         { CONF_CACHE, "mc.log" },
    { CONF_CACHE, MC_TREESTORE_FILE },    { CONF_CACHE, EDIT_HOME_TEMP_FILE },
