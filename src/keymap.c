...
static const global_keymap_ini_t default_editor_keymap[] = {
    ...
    { "Quit", "f10; esc" },
    { "UserMenu", "shift-f1" },
    { "SaveAs", "shift-f2; ctrl-f2" },
    { "MarkColumn", "shift-f3" },
    { "ReplaceContinue", "shift-f4; ctrl-f4" },
    { "InsertFile", "shift-f5" },
    { "SearchContinue", "shift-f7; ctrl-f7" },
    { "EditNew", "ctrl-n" },
    { "DeleteToWordBegin", "alt-backspace" },
    { "DeleteToWordEnd", "alt-d" },
    { "DeleteLine", "ctrl-y" },
