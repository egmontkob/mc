...
//    { MCKEY_F (10), "k0" },  // map F0 to F10  do we need this??
    { MCKEY_F (1), "k1" },  // termcap's function key 1
    { MCKEY_F (2), "k2" },
    { MCKEY_F (3), "k3" },
    { MCKEY_F (4), "k4" },
    { MCKEY_F (5), "k5" },
    ...
    { MCKEY_F (8), "k8" },
    { MCKEY_F (9), "k9" },
    { MCKEY_F (10), "k;" },  // termcap's function key 10
    { MCKEY_M_SHIFT | MCKEY_F (1), "F3" },  // termcap's function key 13
    { MCKEY_M_SHIFT | MCKEY_F (2), "F4" },
    { MCKEY_M_SHIFT | MCKEY_F (3), "F5" },
    { MCKEY_M_SHIFT | MCKEY_F (4), "F6" },
    { MCKEY_M_SHIFT | MCKEY_F (5), "F7" },
    { MCKEY_M_SHIFT | MCKEY_F (6), "F8" },
    { MCKEY_M_SHIFT | MCKEY_F (7), "F9" },
    { MCKEY_M_SHIFT | MCKEY_F (8), "FA" },
    { MCKEY_M_SHIFT | MCKEY_F (9), "FB" },
    { MCKEY_M_SHIFT | MCKEY_F (10), "FC" },  // termcap's function key 22
    { MCKEY_INS, "kI" },
    { MCKEY_PGUP, "kP" },
    { MCKEY_PGDN, "kN" },
    { MCKEY_LEFT, "kl" },
