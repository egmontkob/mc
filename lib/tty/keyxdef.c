...
xtra_key_define_t xtra_key_defines[] = {
    ...
    { MCKEY_BACKSPACE, Key_backspace },
    { MCKEY_LEFT, Key_left },
    { MCKEY_RIGHT, Key_right },
    { MCKEY_UP, Key_up },
    { MCKEY_DOWN, Key_down },
    { MCKEY_PGUP, Key_ppage },
    { MCKEY_PGDN, Key_npage },
    { MCKEY_HOME, Key_home },
    { MCKEY_END, Key_end },
    { MCKEY_DEL, Key_dc },
    { MCKEY_INS, Key_ic },
    ...
    { MCKEY_F (9), Key_f9 },
    { MCKEY_F (10), Key_f10 },
    { MCKEY_M_SHIFT | MCKEY_F (1), Key_f13 },
    { MCKEY_M_SHIFT | MCKEY_F (2), Key_f14 },
    { MCKEY_M_SHIFT | MCKEY_F (3), Key_f15 },
    { MCKEY_M_SHIFT | MCKEY_F (4), Key_f16 },
    { MCKEY_M_SHIFT | MCKEY_F (5), Key_f17 },
    { MCKEY_M_SHIFT | MCKEY_F (6), Key_f18 },
    { MCKEY_M_SHIFT | MCKEY_F (7), Key_f19 },
    { MCKEY_M_SHIFT | MCKEY_F (8), Key_f20 },
    { MCKEY_M_SHIFT | MCKEY_F (9), Key_f21 },
    { MCKEY_M_SHIFT | MCKEY_F (10), Key_f22 },
#endif
    { ALT ('a'), Key_alt_a },
    { ALT ('b'), Key_alt_b },
    { ALT ('c'), Key_alt_c },
