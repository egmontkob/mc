...
int *mc_config_get_int_list (mc_config_t *mc_config, const gchar *group, const gchar *param,
                             gsize *length);
gchar **mc_config_get_escape_sequence_list (mc_config_t *mc_config, const gchar *group,
...
void mc_config_set_list_separator (mc_config_t *mc_config, gchar separator);
void mc_config_set_escape_sequence_list (mc_config_t *mc_config, const gchar *group,
                                         const gchar *param, const gchar *value[], gsize length);
